...
<div class="modal fade" id="addTaskModal" tabindex="-1" aria-labelledby="addTaskModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <!-- Form Tag Utama -->
            <form id="dynamicTaskForm" action="{{ route('admin.task.store') }}" method="POST" style="display: flex; flex-direction: column; flex-grow: 1; overflow: hidden;">
                @csrf
...
<!-- AUTOMATIC OPEN MODAL IF THERE IS VALIDATION ERROR -->
@if ($errors->any())
<script>
